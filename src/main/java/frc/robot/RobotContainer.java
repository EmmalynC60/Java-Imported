...
public class RobotContainer {
   ...
   * switch on the top.*/
  //private final Joystick m_leftOperatorController =
    //new Joystick(OperatorConstants.kLeftOperatorControllerPort);
  ...
  private void configureBindings() {
    ...
    // m_DriverController.pov(0).toggleOnTrue(Commands.runEnd(m_drivetrain.slowSpeed(), base speed, null))
    ...
    // pivot up
    m_operatorController.y().whileTrue(new PivotUp(m_intake));
    // pivot down
    m_operatorController.b().whileTrue(new PivotDown(m_intake));
  }
