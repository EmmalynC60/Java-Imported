...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        rightMain.setInverted(true);  // Typically one side inverted for correct motion
    }
    ...
    public void teleopPeriodic() {
        // Tank drive: left stick Y axis controls left side, right stick Y axis controls right side
        double leftSpeed = applyDeadband(-controller.getLeftY(), 0.05) * 0.5;   // 50% speed
        double rightSpeed = applyDeadband(-controller.getRightY(), 0.05) * 0.5; // 50% speed
